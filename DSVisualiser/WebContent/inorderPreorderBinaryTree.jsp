...
<title>Inorder, Preorder To Binary Tree</title>
...
<form method="post" action="InPreBinaryTreeController" class="array">
Enter Inorder array (comma separated, Integers only): <input type="text" name="inorder">
Enter Preorder array (comma separated, Integers only): <input type="text" name="preorder">
