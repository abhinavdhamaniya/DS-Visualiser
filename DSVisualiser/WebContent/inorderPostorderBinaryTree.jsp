<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" import="java.util.*, java.io.IOException, java.io.PrintWriter, javax.servlet.*,com.abhinav.Tree.BinaryTree,javafx.util.Pair" %>
...
<title>Inorder, Postorder To Binary Tree</title>
...
<form method="post" action="InPostBinaryTreeController" class="array">
Enter Inorder array (comma separated, Integers only): <input type="text" name="inorder">
Enter Postorder array (comma separated, Integers only): <input type="text" name="preorder">
...
<svg id="svgid" height="100%" width="100%"></svg>
	...
	<%
		...
		{
				BinaryTree tree= (BinaryTree) request.getAttribute("tree");
